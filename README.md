...
- Both are server config options in `fantasy_technology-server.toml` (`max_fast_mode`, `batch_dispatch_enabled`); `diagnostics` logs why the planner aggregated or fell back. License notice: [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
